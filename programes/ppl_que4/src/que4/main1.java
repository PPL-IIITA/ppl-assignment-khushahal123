	          ...
	          date1 D=new date1();
			   ...
			   for(i=0;i<C.length;i++)
				...
				//System.out.println((i+1) +" th happy couple is " + C[i].bname+ " and "+C[i].gname);
				 ...
				 getout.writeUTF(" Now the least  happy couples have broken up  ");
				 getout.writeUTF(" And the new couple are  ");
				breakup br =new breakup();
				br.broke(B,G,C);
				 /**
				  * breaking up the least happy couple and alloting the new boyfriend to that girl.
				  */
